defmodule EndpointDB.Stats.Unary do
  ...
  def changeset(unary, attrs) do
    unary
    |> cast(attrs, [:endpoint_short_name, :n_cases, :n_controls, :n_excl, :n_gws_hits, :h2, :h2_se, :is_core])
    |> validate_required([:endpoint_short_name, :n_cases, :n_controls, :n_excl, :is_core])
  end
end
